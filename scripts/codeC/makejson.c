...
/*******************************************************************/
	...
	/************************************************************/
	/* affichier l'entrees des variables */
	...
	file = argc[1];//"7lognav_Thu_Aug_23_15h27min02sec_2012.csv";						// DACORD 3.1
//"/home3/homedir4/perso/tloubrie/projets/sensorNanny/vaimos/vaimoskai/codeC/files_csv/lognav_Wed_Jun_12_10h10min02sec_2013.csv";
//"lognav_Wed_Jun_12_10h10min02sec_2013.csv";	  
// lognav_Wed_Jun_12_14h41min02sec_2013.csv
//lognav_Wed_Jun_12_14h57min01sec_2013
//lognav_Wed_Jun_12_15h17min01sec_2013
	//logpower_Wed_Jun_12_10h10min01sec_2013
printf("\n%s\n",file);
	/* recuperer le nom sans slash*/ 
	file1 = (char*)malloc(100*sizeof(char));
        file1 = findnamess(file);
//int nnn;
//	nnn = findslash(file);
//	printf("\n findnamess: %d\n",nnn);
	/* recuperer le nom sans l'extention*/ 
...
*/
	...
	freq = ntab/((float)atof(col2[ntab-1])-(float)atof(col2[1])); 
	printf("\n###frequence d'echantillion### =%f,%d %f (Hz)\n",((float)atof(col2[ntab-1])-(float)atof(col2[1])),ntab,freq);
	...
	qz 	     = (char*)malloc(8*sizeof(char));
	fichiercsv   = (char*)malloc(128*sizeof(char));

	description  = "one time test";
	procedureuri = "http://www.flakey.org/register/process/scales34.xml#platform_number";
	qz 	     = "file://";
	strcat(fichiercsv,qz);
	strcat(fichiercsv,file);
//fichiercsv   =  "file:///home/isi-projets/sensorNanny/data/vaimos/nav/7lognav_Thu_Aug_23_15h27min02sec_2012.csv";	              // DACORD 3.2
	...
	addjson  = (char*)malloc(200*sizeof(char));
	addjson  = argc[2];
//"/home/isi-projets/sensorNanny/dev/vaimos/vaimoskai/codeC/files_json/7lognav_Thu_Aug_23_15h27min02sec_2012.json";                      // DACORD 3.3
//"/home3/homedir4/perso/tloubrie/projets/sensorNanny/vaimos/vaimoskai/codeC/files_json/0lognav_Thu_Aug_23_15h27min02sec_2012.json";
// /home/isi-projets/sensorNanny/dev/vaimos/vaimoskai/codeC/0lognav_Thu_Aug_23_15h27min02sec_2012.json
	printf("\nwritejson :%s ",addjson);
	writejson(resultat,addjson);
	printf("\n*******************    Fin du programme    *************** \
		\n******************* A la prochaine fois :) *********************************************************************************\n\n\n\n");
